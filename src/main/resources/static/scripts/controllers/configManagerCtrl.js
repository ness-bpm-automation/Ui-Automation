...
angular.module('mswFrontendApp')
    .controller('ConfigManagerCtrl', ['$scope','$rootScope','authService', '$http', '$location',  function ($scope, $rootScope, authService, $http, $location) {
    	
    	console.log('Inside Config Manager Controller:::');
    		...
    		$http({
    			...
    			headers: {
    				...
    				function (response) {
    					...
    					$location.path('configManagerSuccess');
    				});		
    	}
